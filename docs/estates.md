...
Operating vineyard programs add their per-hectare and per-district charges to the base upkeep above. Only owned land counts, including empty owned parcels. Unlocking an unowned district adds no agriculture charge; its first purchased parcel adds a program district charge, and each purchased or expanded parcel adds area charges. Purchase previews include these costs.
