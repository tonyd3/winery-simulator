...
**In the vines**, above the estate map, shows every planted parcel in the selected estate with ripeness and vine-health percentages and bars. Click a row to select its parcel. **Tend all** restores up to 16 health points to each eligible parcel, skipping fully healthy, already-tended, harvested and dormant vines. **Harvest all ready** picks all parcels at 80%+ ripeness across that estate’s districts, preserving separate lots and provenance. Both show their total charge and reject the entire action if cash or fresh-lot capacity is insufficient. Other estates are unaffected. Waiting for 100% ripeness remains a quality decision.
...
- **Add a vineyard district:** unlock six parcels totaling 6.8 ha for separate purchase. District prices rise across your whole portfolio: $75,000, $300,000, $675,000, $1.2M, then further increases. Each adds $35 weekly upkeep; a new region does not reset the price. Each parcel costs $14,000–$19,200 and adds $25 weekly upkeep once bought. Buying a district adds no owned land; buy each parcel before planting or enlarging it. Vines, cellar space, and tanks cost extra.
- **Acquire a regional estate:** choose an unowned region and name the estate (or generate a name). Acquisitions cost $250,000, $1M, $2.25M, $4M, $6.25M, $9M, and $12.25M as your portfolio grows. The current and following acquisition prices appear before buying. Includes three empty parcels totaling 3 ha and three neighboring parcels available to buy; cellar equipment is separate. Adds $175 weekly upkeep before further purchases. Existing saves retain all previously owned parcels and historical purchase prices.
...
**Build → Buildings & equipment** has 18 investments grouped into vineyard/cellar, hospitality, sales, and research. Prices range from **$6,000 to $400,000**, with **$180–$3,000 weekly running costs per investment**. Advanced quality investments now cost more than early vineyard care, and advanced breeding studies reach $750,000. Existing purchases, study progress, cash, wine quality and weekly running costs are preserved; see [investment pacing](docs/investments.md#quality-investment-pacing).
...
Use **Suspend** to stop benefits immediately. This week’s full operating bill remains due, then maintenance falls to **25%**, rounded up. Resuming and suspending within the same week cannot avoid that full bill. Ownership is permanent; there is no refund. Dependents also suspend and must be resumed individually. Resuming requires cash for one full week of total estate upkeep. If funds after weekly income cannot cover the bill, bankruptcy closes the estate and requires a new game. Suspend facilities to reduce bills after the current operating week.
...
- **Send for judging · $180 + $3 per bottle in the original release**: enter a release once for an independent panel result in two weeks. Its score varies by up to five points from the original wine rating. Bronze (80+) adds $2 to suggested value and 10% demand; Silver (85+) adds $4 and 20%; Gold (90+) adds $6 and 30%. Below 80, the review remains on record without a bonus. Medals are permanent for that release and also improve wholesale offers. New releases in the same line need their own judging entry. Selling bottles before entry does not lower the fee; only stock remaining when the result arrives can earn the medal’s benefits. For older releases without original production totals, the fee uses remaining bottles plus sales recorded since tracking began. Already-paid entries and awarded medals remain unchanged.

Whole-dollar shelf prices start at **$1 to $1,000**. Bottle your first **98+ point wine** to permanently unlock **Collector pricing**, raising the ceiling to **$10,000 for every release**. The final bottling score counts; a reserve estimate, judging result, or high Prestige alone does not unlock it. Selling or privately collecting the qualifying wine never removes the unlock. Existing lifetime best scores count automatically.

Use the exact price field, steppers, or detail slider. Suggested prices share your current ceiling, giving exceptional wines room to grow in value with Prestige. Valid changes save immediately; incomplete or invalid input returns to the saved price when you leave the field. Click **Suggested: $…** to apply the current suggestion. Marketing and medals raise willingness to pay; they do not change your chosen selling price automatically. Demand bonuses add together and still respond to pricing and stock. Prices far above suggested value can result in no sales. Both Collection and Ledger show each listed release's estimated bottle sales for next week, updating as price and shelf space change. The range accounts for competing listings and cannot exceed shelf stock; unlisted releases show no shop sales. Fees are charged from estate funds, with no bottle consumption or extra cash awards.

Older saves without a 98+ lifetime bottling score adopt the $1,000 ceiling on load or their next action, reducing any higher shelf prices to $1,000. Saves that already qualify retain their prices. This adjustment changes no wine scores, stock, cash, or historical sales accounts.
...
- Version-one through version-five saves migrate automatically to version six, with the original property retained as the home estate and existing 400 L tanks preserved. Existing land soils, vines, funds, inventory, and calendar are preserved; the legacy estate receives Bordeaux as its region. Old bottles keep their scores and stock, and become releases in house wine lines. Prices are retained within the Collector pricing ceiling described above. Original production quantities are marked unrecorded when the old save did not track them. Previously unlocked grapes and owned investments remain available. Paid legacy collection studies keep their original remaining time and promised grape unlocks. Completed legacy techniques receive their new prerequisites. The storage key remains unchanged for compatibility.
