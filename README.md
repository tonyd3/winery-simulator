...
4. Advance two weeks. Maturation then begins automatically for up to eight weeks. **Move to reserves** whenever you are ready to stop maturation and to free all tanks used by that batch. In **Reserves & blending**, store the wine, blend it with other grapes and vintages, or bottle it on its own.
